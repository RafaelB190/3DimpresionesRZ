...
export default function Home() {
  return (
    <div>
      ...
      <section id="promos" className="py-16 px-4 bg-gradient-to-r from-amber-50 to-orange-50">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {promos.map((promo) => (
              <div
                key={promo.id}
                className="bg-white rounded-xl shadow-md p-6 border-2 border-amber-200 hover:shadow-lg transition-shadow"
              >
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-400 text-sm">Entregas en 24-48 horas</p>
            </div>
            <div className="flex flex-col items-center">
              <div className="bg-white/10 p-4 rounded-full mb-4">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-400 text-sm">Encuentra el regalo perfecto</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-blue-600 text-white text-center">
        <div className="container mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">¿Tienes un diseño especial?</h2>
          <p className="text-xl mb-8 opacity-90">Contáctanos y lo imprimimos para ti</p>
          <Link
            href="/contacto"
