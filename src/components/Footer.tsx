        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Empresa familiar dedicada a la impresión 3D. Adornos para eventos y decoración del hogar.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              <li className="flex items-center gap-2">
                ...
                <a href="https://wa.me/543834814217" target="_blank" className="hover:text-white transition">
                  383 481 4217
                </a>
              </li>
              <li className="flex items-center gap-2">
                ...
                <a href="https://www.instagram.com/rz.Impresiones3d" target="_blank" className="hover:text-white transition">
                  @rz.Impresiones3d
                </a>
              </li>
              <li className="flex items-center gap-2">
